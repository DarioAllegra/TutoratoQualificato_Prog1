...
int main()
{
	...
	shared>>shd;
	cout<<shared.str()<<endl;
	
	
	if(nome[0]==cognome[lC-1])
		cout<<"Il primo carattere del nome e' uguale all'ultimo del cognome"<<endl;
	else
		cout<<"Il primo carattere del nome NON e' uguale all'ultimo del cognome"<<endl;
	
	if(lN==lC)
		cout<<"Lunghezza uguale"<<endl;
	else
		cout<<"Lunghezza diversa"<<endl;
	...
	cout<<"Il numero di consonanti del nome e': "<<cNome<<endl;
	cout<<"Il numero di consonanti del cognome e': "<<cCognome<<endl;
	/*
	//***************************
	//Risolvo Punto 3 - 1
	if(nome[0]==cognome[lC-1])
